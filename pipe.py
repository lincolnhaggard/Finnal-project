...
class Pipe:
    def __init__(self,pipe_img,x,y,ontop,reversed=False,flying=False):
        ...
        if reversed:
            ...
            self.mid=pygame.transform.scale(self.mid,(80*3,1400-(self.gap*2)-50))
    ...
    def resize(self,x_offset,y_offset,wdh,hgt):
        ...
        if self.reversed:
            ...
            self.bottom=pygame.transform.scale(self.bottom,(wdh/2560*80*3,hgt/1400*43*3))
            self.mid=pygame.transform.scale(self.mid,(wdh/2560*80*3,hgt/1400*(1400-(self.gap*2)-50)))
        elif self.flying!=False:
            if self.ontop:
                self.mid=pygame.transform.scale(self.mid,(wdh/2560*80*3,hgt/1400*abs(self.pipe_rect.top+300)))
                self.mid_rect.bottom=self.pipe_rect.top+50
            else:
                self.mid=pygame.transform.scale(self.mid,(wdh/2560*80*3,hgt/1400*(1400-self.pipe_rect.bottom+300)))
        else:
